...
insert into treatment_center (center_id, name, street_address, state, city, zip_code, professional_id, email_1, email_2, phone_1, phone_2) values (1, 'MD Anderson Cancer Center', '8773 Old Gate Plaza', 'AL', 'Birmingham', '29', 6, 'vbroxholme0@netvibes.com', 'amcgready0@dailymail.co.uk', '205-449-5880', '720-697-6765');
insert into treatment_center (center_id, name, street_address, state, city, zip_code, professional_id, email_1, email_2, phone_1, phone_2) values (2, 'Memorial Sloan Kettering Cancer Center', '44 Texas Court', 'MA', 'Newton', '8', 3, 'ikeynes1@craigslist.org', 'fhaskell1@taobao.com', '508-112-3218', '805-160-9624');
insert into treatment_center (center_id, name, street_address, state, city, zip_code, professional_id, email_1, email_2, phone_1, phone_2) values (3, 'Mayo Clinic', '51 Dovetail Trail', 'KY', 'Louisville', '7', 7, 'alancley2@nifty.com', 'mburgan2@livejournal.com', '502-584-5922', '202-164-1134');
insert into treatment_center (center_id, name, street_address, state, city, zip_code, professional_id, email_1, email_2, phone_1, phone_2) values (4, 'Dana-Farber Cancer InstituteUCLA Medical Center', '075 Sundown Pass', 'CA', 'San Jose', '7819', 4, 'xhamber3@tiny.cc', 'prougier3@google.ca', '408-143-3468', '804-298-2811');
insert into treatment_center (center_id, name, street_address, state, city, zip_code, professional_id, email_1, email_2, phone_1, phone_2) values (5, 'Cleveland Clinic', '08350 Grayhawk Way', 'NY', 'New York City', '11', 9, 'jhansard4@is.gd', 'cglas4@scientificamerican.com', '212-210-7513', '716-519-2235');
insert into treatment_center (center_id, name, street_address, state, city, zip_code, professional_id, email_1, email_2, phone_1, phone_2) values (6, 'Memorial Sloan Kettering Cancer Center', '4425 South Plaza', 'GA', 'Atlanta', '8', 13, 'rcowle5@goodreads.com', 'ldickenson5@so-net.ne.jp', '404-522-1254', '215-256-6422');
insert into treatment_center (center_id, name, street_address, state, city, zip_code, professional_id, email_1, email_2, phone_1, phone_2) values (7, 'Mayo Clinic', '44 Maple Circle', 'PA', 'Bethlehem', '8901', 10, 'fhinkens6@theguardian.com', 'gphillipps6@uiuc.edu', '610-397-3972', '206-875-8447');
insert into treatment_center (center_id, name, street_address, state, city, zip_code, professional_id, email_1, email_2, phone_1, phone_2) values (8, 'Dana-Farber Cancer Institute', '1762 Oxford Center', 'CO', 'Denver', '63892', 8, 'mhurne7@discuz.net', 'bbaldazzi7@hud.gov', '303-748-8552', '727-318-6917');
insert into treatment_center (center_id, name, street_address, state, city, zip_code, professional_id, email_1, email_2, phone_1, phone_2) values (9, 'Treatable Counsel', '790 Florence Point', 'CA', 'Orange', '4', 7, 'mhuffey8@hexun.com', 'mklossmann8@friendfeed.com', '760-170-4763', '312-364-9811');
insert into treatment_center (center_id, name, street_address, state, city, zip_code, professional_id, email_1, email_2, phone_1, phone_2) values (10, 'LifeMotion Clinic', '8653 Katie Circle', 'TX', 'Austin', '93', 9, 'codevey9@over-blog.com', 'ashimon9@elegantthemes.com', '512-506-8312', '559-849-4933');
insert into treatment_center (center_id, name, street_address, state, city, zip_code, professional_id, email_1, email_2, phone_1, phone_2) values (11, 'Etisson Women Hospital', '31803 Killdeer Court', 'AZ', 'Phoenix', '09', 5, 'hcamelia@pinterest.com', 'walesioa@multiply.com', '623-187-8557', '513-108-0537');
